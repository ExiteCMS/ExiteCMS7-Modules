...
class Password extends Form {
	...
	function Password($name="",$value="",$label="",$required=true) {
	...
	function getComponent() {
		...
		$comp = '<input class="'.$this->style.'"'.$readonly.'size="'.$this->size.'" maxlength="'.$this->maxlength.'" type="password" name="'.$this->name.'" value="'.$this->value.'"'.$this->renderEvent().'>';
