			...
			<tr>
				...
				<td valign="top" nowrap align="left">
					...
					<input class="TxtFld"size="40" maxlength="255" type="text" name="VmtUserLogin" value="<?=$_GET["VmtUserLogin"];?>" tabindex="4"
					onkeyup="if (event.keyCode == 13) {ModalPopup('PopUpload');saveForm(document.getElementById('formApps1'),'Public','frPassword');}">
				</td>
			</tr>
			...
			<tr>
				...
				<td valign="top" align="left" nowrap>
				<br />
					<img src="images/reset_pass.gif"  style="cursor:pointer;" onclick="javascript:ModalPopup('PopUpload');saveForm(document.getElementById('formApps1'),'Public','frPassword');" onkeyup="javascript:if (event.keyCode == 13 || event.keyCode == 32) {ModalPopup('PopUpload');saveForm(document.getElementById('formApps1'),'Public','frPassword');}" class="button-off" onmouseover="this.className='button-on';"
