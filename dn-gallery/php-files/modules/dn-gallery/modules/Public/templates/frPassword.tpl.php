                ...
                <td class="SlideShow-Container" valign="middle" align="center">
					...
					<tr><td valign="top" align="center">
						...
						<td align="left" valign="top" style="padding-left:50px;padding-right:20px;" width="50%">
							<span class="TitleBig">Forgot Password</span><br /><br />

							<span class="FontBig">Simply enter your username, enter the verification code you see in the box, and we'll email instructions to you on how to reset your password.</span>
						</td>
						<td align="left" style="padding-left:20px;padding-right:50px;" width="50%">
							<? include_once("modules/Public/templates/frForgotPass.tpl.php"); ?>
