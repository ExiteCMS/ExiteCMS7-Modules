	  ...
	  <tr>
		<td valign="top" width="100%">
              ...
              <tr> 
                <td class="SlideShow-Container" valign="top">
			...
			<tr>
			<td align="center" valign="top" style="padding-right:50px;">
				<? include_once("modules/Public/templates/frLog.tpl.php"); ?>
			</td>
			<td align="center" style="padding-left:50px;">
				<? include_once("modules/Public/templates/frReg.tpl.php"); ?>
			</td>
			</tr>
			</table>
