...
$countries['BS'] = array('25.0667', '-77.3333', 0);
...
$countries['CU'] = array('23.1333', '-82.3833', 0);
...
$countries['KY'] = array('19.3333', '-81.4000', 0);
...
$countries['ME'] = array('42.7833', '19.4667', 0);
...
$countries['MV'] = array('4.1667', '73.5000', 0);
...
$countries['PF'] = array('-17.5667', '-149.6000', 0);
...
$countries['RS'] = array('44.8000', '20.5000', 0);
...
if ($google_key != "") {
	...
	while ($data = dbarray($result)) {
		if (isset($countries[$data['dlsi_ccode']])) {
			$countries[$data['dlsi_ccode']][2] = $data['count'];
			$countries[$data['dlsi_ccode']][3] = GeoIP_Code2Name($data['dlsi_ccode']);
		} else {
			$countries['??'][2]++;
//			echo $data['dlsi_ccode'],"<br>";
		}
	}
...
$template_panels[] = array('type' => 'body', 'name' => 'modules.download_statistics.geomap', 'template' => 'modules.download_statistics.geomap.tpl', 'locale' => "modules.download_statistics");
$template_variables['modules.download_statistics.geomap'] = $variables;
