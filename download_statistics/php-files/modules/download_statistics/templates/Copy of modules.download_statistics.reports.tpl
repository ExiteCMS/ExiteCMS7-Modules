{***************************************************************************}
{*                                                                         *}
{* ExiteCMS template: modules.download_statistics.dlstats_reports.tpl      *}
{*                                                                         *}
{***************************************************************************}
{*                                                                         *}
...
{* 2007-12-26 - WW - Converted from a branch specific to a common module   *}
{*                                                                         *}
{***************************************************************************}
{*                                                                         *}
{* Template for the module download_statistics: reporting panel            *}
{*                                                                         *}
{***************************************************************************}
		...
		<tr>
			<td align='center' class='tbl'>
				...
				<select name='filter' class='textbox' style='width:200px;'>
					...
					<option value='A'{if $filter == 'A'} selected="selected"{/if}>{$locale.dls141}</option>
					<option value='B'{if $filter == 'B'} selected="selected"{/if}>{$locale.dls142}</option>
					<option value='C'{if $filter == 'C'} selected="selected"{/if}>{$locale.dls143}</option>
				</select>
			</td>
		</tr>
		<tr>
