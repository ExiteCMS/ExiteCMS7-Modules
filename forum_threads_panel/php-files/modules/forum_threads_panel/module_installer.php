...
+----------------------------------------------------*/
$mod_title = "Forum threads side panel";
$mod_description = "Shows the latest and the hottest few threads in a side panel, with links to those threads";
$mod_version = "1.0.0";
...
$mod_folder = "forum_threads_panel";
