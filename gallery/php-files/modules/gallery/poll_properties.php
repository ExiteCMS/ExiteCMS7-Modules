...
<input type="submit" class="button" name="apply" value="<?php echo _("Apply") ?>">
<input type="reset" class="button" value="<?php echo _("Undo") ?>">
<input type="submit" class="button" value="<?php echo _("Close") ?>" onclick='parent.close()'>
